...
@section('content_header')
    <div class="d-flex justify-content-between">
        <h1>Permisos</h1>
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#newPermisosModal"><i class="fa fa-plus" aria-hidden="true"></i> Permiso</button>
    </div>
@stop
...
@section('content')
    ...
    <div id="content">
        <div class="card">
            <div class="card-body">
                @if (session('success') == 'Permiso guardado')
                    <x-adminlte-alert theme="success" title="Permiso guardado" id="success-alert">
                ...
                <x-adminlte-datatable id="table1" :heads="$heads" :config="$config">
                    @foreach($permisos as $permiso)
                        <tr>
                            ...
                            <td>{{ $permiso->name }}</td>
                            <td>
                                <button class="btn btn-xs btn-default text-primary mx-1 shadow edit-button" data-id="{{ $permiso->id }}" title="Edit">
                                    <i class="fa fa-lg fa-fw fa-pen"></i>
                                </button>
                                
                                <form style="display: inline" action="{{ route('permisos.destroy', $permiso->id) }}" method="post" class="formEliminar">
                                    @csrf
                                    @method('DELETE')
                                    {!! $btnDelete !!}
                                </form>
        ...
        <div class="modal fade" id="newPermisosModal" tabindex="-1" role="dialog" aria-labelledby="newPermisosModalLabel" aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div id="form-content">
                            ...
                            @endif
                            <form id="productForm" action="{{ route('permisos.store') }}" method="post">
                                @csrf
                                <x-adminlte-input type="text" name="nombre" label="Nombre" placeholder="nuevo permiso" label-class="text-lightblue" value="{{ old('nombre') }}">
            ...
            $('.edit-button').click(function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#productForm').attr('action', '/permisos/' + id);
