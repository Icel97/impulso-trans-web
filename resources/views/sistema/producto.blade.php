                ...
                <x-adminlte-datatable id="table1" :heads="$heads" :config="$config">
                    @foreach($productos as $producto)
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-xs btn-default text-primary mx-1 shadow edit-button" data-id="{{ $producto->id }}" title="Edit">
                                    <i class="fa fa-lg fa-fw fa-pen"></i>
                                </button>
                                
                                <form style="display: inline" action="{{ route('productos.destroy', $producto->id) }}" method="post" class="formEliminar">
                                    @csrf
                                    @method('DELETE')
                                    {!! $btnDelete !!}
                                </form>
